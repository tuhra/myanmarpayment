        ...
        <div class="wrap-sm">
            <div class="card">
                ...
                <ul>
                    ...
                    <li>
                    <span class="zawgyione mpt_sub_price"><b>{{ trans('app.mpt_sub_price') }}</b></span>
                    {{ trans('app.mpt_sub_desc_four') }}</span></li>
                    <li><span class="mm-zawgyione">{{ trans('app.sub_desc_four') }}</span></li>
                </ul>
                <div class="row">
                    <button type="submit"><span class="mm-zawgyione"><a style="color: white;" href="{{ url('/mpt/ma/T&C') }}">{{ trans('app.nextButton') }}</span></a></button>
                </div>
            </div>
        </div>
    </body>
