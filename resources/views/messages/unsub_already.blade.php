...
<div class="wrap-sm text-center">
    ...
    <div class="lead">
        <p>
            <span class="mm-zawgyione">{{ trans('app.unsub_already') }}</span>
        </p>
    </div>
    <div class="row">
        <a href="{{url('wave.gogamesapp.com')}}" class="btn-submit"><span class="mm-zawgyione">{{trans('app.continue')}}</span></a>
    </div>
</div>
@stop