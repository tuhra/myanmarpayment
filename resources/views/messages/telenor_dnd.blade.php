...
<div class="wrap-sm text-center">
    ...
    <div class="lead">
        <p>
         	<span class="mm-zawgyione">{{trans('app.dnd_message')}}</span>
        </p>
    </div>
    <div class="row">
        <button type="submit"><a class="btn-submit" href="{{url('/')}}"><span class="mm-zawgyione">{{trans('app.continue')}}</span></a></button>
    </div>
</div>
@stop
