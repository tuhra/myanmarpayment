...
<script>
  ...
  fbq('track', 'TelenorAlreadySubscribed');
</script>
@stop
@section('content')
<div class="wrap-sm text-center">
	...
	<h3>Yay!</h3>
	<div class="lead">
    	<p><span>{{trans('app.already_exist')}}</span></p>
    </div>
    <div class="row">
        <button type="submit"><a href="{{url('/telenor/continue')}}" class="btn-submit"><span class="mm-zawgyione">{{trans('app.continue')}}</span></a></button>
    </div>
</div>
@stop